...
public class Shootout extends SequentialCommandGroup {
  ...
  public Shootout(Shooter shooter) {
    ...
    addCommands(
      Commands.print("Shootout running"),
        // new InstantCommand(() ->
        // target.getTargetStatus(LimelightHelpers.getFiducialID(VisionConstants.LLName))),
        // new RunCommand(() -> swerve.applyRequest(() ->
        // point.withModuleDirection(target.getAimingRotation(LimelightHelpers.getBotPose2d(VisionConstants.LLName))))),
